...
export class DisplayModComponent {
  ...
  constructor(private glycanService: GlycanService, private toast: MatSnackBar, private dialog: MatDialog, private unimodService: UnimodService, private psiModService: PSIModService, private xlModService: XLModService, private cdr: ChangeDetectorRef) {
  }
